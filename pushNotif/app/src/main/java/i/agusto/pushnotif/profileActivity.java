...
public class profileActivity extends AppCompatActivity {
    ...
    private static final String Channel_id = "PushNotif";
    private static final String Channel_name = "NotifRemind";
    private static final String Channel_desc = "Reminder of Life";
